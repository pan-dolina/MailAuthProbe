...
`,
		...
		{"a with /0", "example.test. TXT \"v=spf1 a/0 -all\"\nexample.test. A 192.0.2.1", []string{"MAIL-SPF-011"}, false},
		{"mx with //0", "example.test. TXT \"v=spf1 mx//0 -all\"\nexample.test. MX 10 example.test.\nexample.test. AAAA 2001:db8::1", []string{"MAIL-SPF-011"}, false},
